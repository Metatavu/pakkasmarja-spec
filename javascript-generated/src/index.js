...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Address', 'model/BadRequest', 'model/Contact', 'model/Contract', 'model/ContractDocumentSignRequest', 'model/Forbidden', 'model/InternalServerError', 'model/ItemGroup', 'model/NotFound', 'model/NotImplemented', 'model/Operation', 'model/OperationReport', 'model/OperationReportItem', 'api/ContactsApi', 'api/ContractsApi', 'api/ItemGroupsApi', 'api/OperationReportsApi', 'api/OperationsApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/Address'), require('./model/BadRequest'), require('./model/Contact'), require('./model/Contract'), require('./model/ContractDocumentSignRequest'), require('./model/Forbidden'), require('./model/InternalServerError'), require('./model/ItemGroup'), require('./model/NotFound'), require('./model/NotImplemented'), require('./model/Operation'), require('./model/OperationReport'), require('./model/OperationReportItem'), require('./api/ContactsApi'), require('./api/ContractsApi'), require('./api/ItemGroupsApi'), require('./api/OperationReportsApi'), require('./api/OperationsApi'));
  }
}(function(ApiClient, Address, BadRequest, Contact, Contract, ContractDocumentSignRequest, Forbidden, InternalServerError, ItemGroup, NotFound, NotImplemented, Operation, OperationReport, OperationReportItem, ContactsApi, ContractsApi, ItemGroupsApi, OperationReportsApi, OperationsApi) {
  'use strict';
