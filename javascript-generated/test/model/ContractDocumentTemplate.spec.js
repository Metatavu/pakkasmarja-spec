...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PakkasmarjaRestClient.ContractDocumentTemplate();
  });
  ...
  describe('ContractDocumentTemplate', function() {
    it('should create an instance of ContractDocumentTemplate', function() {
      // uncomment below and update the code to test ContractDocumentTemplate
      //var instane = new PakkasmarjaRestClient.ContractDocumentTemplate();
      //expect(instance).to.be.a(PakkasmarjaRestClient.ContractDocumentTemplate);
    });
