...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PakkasmarjaRestClient.Credentials();
  });
  ...
  describe('Credentials', function() {
    it('should create an instance of Credentials', function() {
      ...
      //var instane = new PakkasmarjaRestClient.Credentials();
      //expect(instance).to.be.a(PakkasmarjaRestClient.Credentials);
    });
