...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SoteapiClient.ContactsApi();
  });
  ...
  describe('ContactsApi', function() {
    describe('findContact', function() {
      it('should call findContact successfully', function(done) {
        //uncomment below and update the code to test findContact
        //instance.findContact(function(error) {
